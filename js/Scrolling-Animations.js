...
OnlineClass1.set(".polaroid6",{top: "165%", left:"92%", width:"20%", rotation: 5},"0.0");
//Paloroid Set [3]
OnlineClass1.set(".polaroid7",{top: "175%", left:"11%", width:"19.5%", rotation: 7},"0.0");
OnlineClass1.set(".polaroid8",{top: "190%", left:"86%", width:"18%", rotation: -18},"0.0");
...
//Paloroid Animated
OnlineClass1.to(".polaroid1, .polaroid2, .polaroid3, .polaroid5",8,{y:"-500%"},">")
...
OnlineClass1.to(".polaroid6, .polaroid8",12,{y:"-1000%"},"<")
OnlineClass1.to(".polaroid7, .polaroid9",12,{y:"-600%"},"<+00.8")
